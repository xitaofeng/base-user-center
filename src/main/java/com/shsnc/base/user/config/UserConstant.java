...
public class UserConstant {
    ...
    /** 用户启用状态 */
    public static int USER_STATUS_ENABLED = 1;
    /** 用户禁用状态 */
    public static int USER_STATUS_DISABLED = 2;
    /** 用户被锁住状态 */
    public static int USER_STATUS_LOCKED = 3;
    /** 用户未删除 */
    public static int USER_DELETEED_FALSE = 1;
    /** 用户已删除 */
    public static int USER_DELETEED_TRUE = 2;
    /** 用户不是内部使用 */
    public static int USER_INTERNAL_FALSE = 1;
    /** 用户是内部使用 */
    public static int USER_INTERNAL_TRUE = 2;
